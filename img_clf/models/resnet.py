...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_block, num_classes=100):
        ...
        # we use a different input size than the original paper, so conv2_x's stride is 1
    ...
    def _make_layer(self, block, out_channels, num_blocks, stride):
        """
        Make resnet layers. By the i-th layer, we didn't mean this 'layer' was the
        same as a neuron network layer, e.g. conv layer).
