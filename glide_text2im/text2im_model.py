...
class SuperResText2ImUNet(Text2ImUNet):
    """
    A text-to-image model that performs super-resolution.
...
class InpaintText2ImUNet(Text2ImUNet):
    """
    A text-to-image model which can perform in-painting.
    """
...
class SuperResInpaintText2ImUnet(Text2ImUNet):
    """
    A text-to-image model which can perform both upsampling and in-painting.
    """
