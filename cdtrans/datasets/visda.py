...
class VisDA(BaseImageDataset):
    ...
    def __init__(self, cfg, root_train='./datasets/reid_datasets/Corrected_Market1501',
        ...
        # self.syn_dir = "../data/glide_image_visda_2017/"
        ...
        self.train_name = os.path.dirname(root_train).split('/')[-1]
        # self.test_name = os.path.dirname(root_test).split('/')[-1]
        self.val_name = os.path.dirname(root_val).split('/')[-1]
        ...
        if verbose:
            print(">>> VisDA-2017 dataset loaded")
