...
from mplug.dataset.utils import pre_question
...
class vqa_dataset(Dataset):
    def __init__(self, ann_file, transform, vqa_root, vg_root, gqa_root, eos='[SEP]', split="train", max_ques_words=30,
                 answer_list='', read_local_data=True, add_ocr=False, add_object=False):
        self.split = split
        self.ann = []
        for f in ann_file:
