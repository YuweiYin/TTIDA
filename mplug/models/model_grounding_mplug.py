...
# from mplug.models.vit import VisionTransformer, interpolate_pos_embed
# from mplug.models.modeling_mplug import BertConfig, BertModel, BertPrefixModel, BertEncoder, \
#     BertPrefixModelForGrounding, FusionModel
from mplug.models.modeling_mplug import BertModel, BertPrefixModel, BertEncoder, \
    BertPrefixModelForGrounding, FusionModel
from transformers import BertConfig
# from transformers.models.bert.configuration_bert import BertConfig
from mplug.models.visual_transformers import initialize_clip
from mplug.vgTools.utils.box_utils import xywh2xyxy, generalized_box_iou
...
class MPLUG(nn.Module):
    def __init__(self,
        ...
        for module in self.visual_encoder.modules():
            from mplug.models.clip.model import Transformer
        ...
        self.fusion_encoder = FusionModel.from_pretrained(text_encoder, config=self.config_fusion,
        ...
        target_ids = torch.tensor(
            self.tokenizer.convert_tokens_to_ids([f'[unused{340 + _}]' for _ in range(config['image_res'] + 1)]))
    ...
    def forward(self, image_data, text_data, extra: dict):
        ...
        if 'targets' in extra:
            ...
            for _ in range(4):
                ...
                prefix_ids = torch.cat([prefix_ids, torch.argmax(answer_output.logits[:, -1, :], dim=-1).unsqueeze(1)],
                                       dim=1)
