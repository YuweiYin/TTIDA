...
from mplug.models.modeling_mplug import BertModel, BertPrefixModel, FusionModel
from transformers import BertConfig
# from transformers.models.bert.configuration_bert import BertConfig
# from mplug.models.modeling_mplug import BertConfig, BertModel, BertPrefixModel, FusionModel
from mplug.models.visual_transformers import initialize_clip
from mplug.models.predictor import TextGenerator
# from mplug.models.vit import VisionTransformer
...
class MPLUG(nn.Module):
    def __init__(self, tokenizer=None, config=None, ):
        ...
        self.text_encoder = BertModel.from_pretrained(
            config['text_encoder'], config=self.config_encoder, add_pooling_layer=False)
        self.fusion_encoder = FusionModel.from_pretrained(
            config['text_encoder'], config=self.config_fusion, add_pooling_layer=False)
