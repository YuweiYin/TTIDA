...
# from mplug.models.modeling_mplug import BertConfig, BertModel, BertLMHeadModel, FusionModel
from mplug.models.modeling_mplug import BertModel, BertLMHeadModel, FusionModel
    ...
    def init_distill(self, config):
        ...
        if self.distill:
            ...
            self.text_encoder_m = BertModel.from_pretrained(config['text_encoder'], config=self.config_encoder,
                                                            add_pooling_layer=False)
            self.fusion_encoder_m = FusionModel.from_pretrained(config['text_encoder'], config=self.config_fusion,
                                                                add_pooling_layer=False)
